...
import com.samyrat.artbookjava.databinding.ActivityArtBinding;
import com.samyrat.artbookjava.databinding.ActivityMainBinding;
...
public class ArtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.equals("new")){
            ...
            binding.imageView.setImageResource(R.drawable.selecetimage);
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU){
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_MEDIA_IMAGES) != PackageManager.PERMISSION_GRANTED){
                if(ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_MEDIA_IMAGES)){
                    Snackbar.make(view,"Permission needed for gallery" , Snackbar.LENGTH_INDEFINITE).setAction("Give Permissions", new View.OnClickListener() {
                        @Override
